...
CREATE POLICY IF NOT EXISTS "Users can create risks in their projects"
...
CREATE POLICY IF NOT EXISTS "Users can view risks in their projects"
ON public.risk_register
FOR SELECT
USING (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Users can update risks in their projects"
ON public.risk_register
FOR UPDATE
USING (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Users can delete risks in their projects"
ON public.risk_register
FOR DELETE
USING (
  EXISTS (
...
DROP TRIGGER IF EXISTS set_risk_register_department ON public.risk_register;
